 ...
 */
public class MultiThreadPostClient {
    private String url;
    private int threadNum;
    private List<Metrics> metrics;
    private List<List<SingleRideData>> listOfThreadData;

    public MultiThreadPostClient(String url, int threadNum, List<Metrics> metrics, List<List<SingleRideData>> listOfThreadData) {
        this.url = url;
    ...
    public void runMultithread() {
        ...
        for (int i = 0; i < threadNum; i++) {
            ...
            metrics.add(mt);
            SingleThreadPostClient worker = new SingleThreadPostClient(webTarget, mt, listOfThreadData.get(i));
